        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                    {product.variants.map((variant) => (
                      <div key={variant.id} className="flex items-center gap-3 p-4 rounded-2xl bg-surface/40 border border-white/5 hover:border-accent/30 transition-all duration-300">
                        <div className="w-10 h-10 rounded-full bg-accent/10 flex items-center justify-center text-accent">
                          <Weight size={18} />
                        </div>
                        <div>
                          <span className="block text-xs text-foreground-muted uppercase tracking-wider mb-1">Weight</span>
                          <span className="block text-lg font-bold text-white">{variant.weight}</span>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-surface/60 backdrop-blur-md p-8 rounded-3xl border border-white/10 shadow-xl sticky top-24">
