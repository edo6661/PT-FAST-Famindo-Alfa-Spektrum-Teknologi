...
const FloatingWA = () => {
  ...
  const message = "Halo tim PT. FAST, saya tertarik untuk berkonsultasi mengenai solusi Fire Safety dan mitigasi risiko baterai Lithium-ion untuk fasilitas/perusahaan saya.";
